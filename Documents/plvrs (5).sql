...
--
-- Dumping data for table `tbl_letterforregistration`
--

INSERT INTO `tbl_letterforregistration` (`u_ID`, `letterPath`) VALUES
(0, 'assets/1y3azmmhoii71.jpg'),
(0, 'assets/nklt6w1nbii71.png'),
(0, 'assets/E9PJX98VUAYBXQC.jpg'),
(0, 'assets/1y3azmmhoii71.jpg'),
(0, 'assets/36240012_p0_master1200.jpg'),
(0, 'assets/36240012_p0_master1200.jpg'),
(0, 'assets/3847a815b1538b07c23c9b3122725627.jpg'),
(0, 'assets/155170801_1710773862435613_6027876242223513334_o.png'),
(0, 'assets/155170801_1710773862435613_6027876242223513334_o.png'),
(0, 'assets/297_HuTao_.png'),
(0, 'assets/297_HuTao_.png'),
(37, 'assets/92564859_p0_master1200.jpg'),
(37, 'assets/92608336_p1.png'),
(37, 'assets/Sangonomiya.Kokomi.full.3409182.png'),
(13, 'assets/E9PJX98VUAYBXQC.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_letterforreservation`
--

CREATE TABLE `tbl_letterforreservation` (
  `r_ID` int(11) NOT NULL,
  `letterPath` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_letterforreservation`
--

INSERT INTO `tbl_letterforreservation` (`r_ID`, `letterPath`) VALUES
(15, 'assets/E9PJX98VUAYBXQC.jpg'),
(15, 'assets/E9PJX98VUAYBXQC.jpg'),
(15, '	\r\nassets/nklt6w1nbii71.png');
...
(40, 13, 0, '2021-12-06 21:31:04', 2),
(41, 13, 0, '2021-12-06 21:57:02', 2),
(42, 0, 0, '2021-12-07 13:39:42', 2),
(43, 0, 0, '2021-12-07 13:51:44', 2),
(44, 0, 0, '2021-12-07 14:18:03', 2),
(45, 0, 0, '2021-12-07 15:09:29', 2),
(46, 0, 0, '2021-12-07 15:10:51', 2),
(47, 0, 0, '2021-12-07 15:11:25', 2),
(48, 0, 0, '2021-12-07 15:36:56', 2),
(49, 0, 0, '2021-12-07 15:37:14', 2),
(50, 0, 0, '2021-12-07 15:37:30', 2),
(51, 0, 0, '2021-12-07 15:38:50', 2),
(52, 0, 0, '2021-12-07 15:39:02', 2),
(53, 0, 0, '2021-12-07 15:40:16', 2),
(54, 0, 0, '2021-12-07 15:40:21', 2),
(55, 0, 0, '2021-12-07 15:40:28', 2),
(56, 0, 0, '2021-12-07 15:41:32', 2);
...
INSERT INTO `tbl_reservation` (`r_ID`, `r_event`, `r_eventAdviser`, `r_startDateAndTime`, `r_endDateAndTime`, `r_status`, `r_user_ID`, `r_approved_ID`, `r_room_ID`, `r_reviewed`, `r_letter_file`, `r_Remarks`, `isDeleted`, `notificationID`, `DateStart`, `DateEnd`, `TimeStart`, `TimeEnd`) VALUES
...
(13, 'Hello', '', '2021-11-30 14:53:50', '2021-11-30 14:53:52', 0, 13, 1, 2, 0, 'Admin Darilag GarciaID', '', 0, 38, '2021-12-04', '2021-12-04', '08:00:00', '09:00:00'),
(14, 'Multiequipp', '', '2021-11-30 15:19:41', '2021-11-30 15:19:43', 0, 14, 1, 5, 0, 'Admin Darilag GarciaID', '', 0, 26, '2021-12-04', '2021-12-04', '08:00:00', '09:00:00'),
(15, 'asdasd', 'asdasdasd', NULL, NULL, 0, 13, 1, 1, 0, 'Admin Darilag GarciaID', '', 0, 40, '2021-12-09', '2021-12-09', '08:00:00', '09:00:00'),
(16, 'asd', 'asd', NULL, NULL, 0, 13, 1, 4, 0, 'Admin Darilag GarciaID', '', 0, 41, '2021-12-09', '2021-12-09', '08:00:00', '09:00:00');
...
(16, 'oapskdpoaskdpo@gmail.com', '$2y$10$jT2mkW2tHgQknJQ2RcepDOh74.JFX0A8mrPofZV7aLKw0EpTdlVbi', 'PK P\'SEOF', 'pow krpOQAWKDPO', 'K QDPO', '9994761120', 1, 'C:/xampp/htdocs/practice/assets/73952907_p0_master1200.jpg', 0, 3, 0, 12),
(17, 'Sjdoiajsdoi@gmail.com', '$2y$10$ppFZyBr.ur/Dc6F6up7JcebU40uP5gpiPbrYCZerdAsVIfpj8XWW.', 'SDIFIMI', 'o feg', 'adsfv asdfg', '9994875123', 1, '238940587_3150593868501949_3453972231494101211_n.jpg', 0, 3, 0, 11),
(20, 'asdasdasd@gmail.com', '$2y$10$1feiAc27SRZ1fPrdbyZHSuOjqOCNFwcnM2BCKsVfPC5dhTW03lQi6', 'oikijoiasijdoi', 'jdoiasjdoi', 'sdasdqasd', '10923810298', 1, 'ID', 0, 2, 0, 11),
(37, 'Sample1230@gmail.com', '$2y$10$KjFLjLKnp5xAGGPIIdgR/eO2qIN00mr6sJitJELFcQk4hLz1rTGNa', 'oiasjkdoi', 'jodiajsdoi', 'dasd', '9994761209', 1, NULL, 0, 2, 0, 11);

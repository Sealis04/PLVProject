...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2021 at 07:46 AM
...
(5, 17, 0, '2021-11-01 16:07:54', 2),
(7, 13, 0, '2021-11-01 16:22:32', 2),
...
CREATE TABLE `tbl_reservation` (
  ...
  `isDeleted` tinyint(4) DEFAULT 0,
  `notificationID` int(11) NOT NULL,
  `r_EventAdviser` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_reservation` (`r_ID`, `r_event`, `r_startDateAndTime`, `r_endDateAndTime`, `r_status`, `r_user_ID`, `r_approved_ID`, `r_room_ID`, `r_reviewed`, `r_letter_file`, `r_Remarks`, `isDeleted`, `notificationID`, `r_EventAdviser`) VALUES
(1, NULL, '2021-11-04 08:00:00', '2021-11-04 09:00:00', 0, 13, 1, 1, 0, 'C:/xampp/htdocs/practice/assets/1y3azmmhoii71.jpg', '', 0, 7, NULL),
(2, NULL, '2021-12-04 08:00:00', '2021-11-04 09:00:00', 0, 14, 1, 2, 0, 'C:/xampp/htdocs/practice/assets/E-NDAZLVEA0ygxS.jfif', '', 0, 8, NULL),
(3, NULL, '2021-11-04 08:00:00', '2021-11-04 09:00:00', 0, 14, 1, 3, 0, 'C:/xampp/htdocs/practice/assets/1626979229572.png', '', 0, 13, NULL),
(4, NULL, '2021-11-04 08:00:00', '2021-11-04 09:00:00', 0, 14, 1, 4, 0, 'C:/xampp/htdocs/practice/assets/1y3azmmhoii71.jpg', '', 0, 15, NULL),
(5, NULL, '2021-11-04 08:00:00', '2021-11-04 09:00:00', 0, 14, 2, 5, 0, 'C:/xampp/htdocs/practice/assets/E9isbMnVcAI3j8f.jpg', '', 0, 28, NULL);
...
(9, 'Holding Area', 0, 'Holding Area', 0, 0),
(10, 'adsg', 1245, 'awd', 0, 0),
(11, 'zcvb', 136, 'asd', 0, 0),
(12, 'zbz', 0, '124', 0, 0),
(13, 'zbz', 0, '124', 0, 0),
(14, 'cvn', 0, 'afzxv', 0, 0),
(15, 'vbnrh', 0, 'ae123', 0, 0),
(16, 'vbnrh', 0, 'ae123', 0, 0);
...
CREATE TABLE `tbl_user` (
  ...
  `notificationID` int(11) NOT NULL,
  `user_YearAndSection` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_user` (`user_ID`, `user_email`, `user_password`, `user_firstName`, `user_middleName`, `user_lastName`, `user_contactNumber`, `user_course_ID`, `PLV_ID`, `isAdmin`, `isApproved`, `r_marked`, `notificationID`, `user_YearAndSection`) VALUES
(13, 'admin1@gmail.com', '$2y$10$AWJtx8Od.kq/3XCnnPGO0.KYknstQL8COfywaUz7FswJ7N5B/5o1K', 'Bryan', 'Darilag', 'Garcia', '9399465176', 1, 'C:/xampp/htdocs/practice/assets/plvrs (4).sql', 1, 1, 0, 1, NULL),
(14, 'user1@gmail.com', '$2y$10$ZLiYnQmADleMdiI.UO5EWesok.d4WqwYdH3kqo4sPanAQu.LvHUpG', 'Bryan', 'Darilag', 'Garcia', '9399465176', 1, 'C:/xampp/htdocs/practice/assets/plvrs (4).sql', 0, 1, 0, 2, NULL),
(15, 'user2@gmail.com', '$2y$10$ej/E2MuY.7KzwB6LbAhlquQh4Sp6sUWs6dEONhlNjiEflrvRAhqFu', 'Juan', 'Pedro', 'Penduko', '9098898899', 1, 'C:/xampp/htdocs/practice/assets/plvrs (4).sql', 0, 3, 0, 3, NULL),
(16, 'oapskdpoaskdpo@gmail.com', '$2y$10$jT2mkW2tHgQknJQ2RcepDOh74.JFX0A8mrPofZV7aLKw0EpTdlVbi', 'PK P\'SEOF', 'pow krpOQAWKDPO', 'K QDPO', '9994761120', 1, 'C:/xampp/htdocs/practice/assets/73952907_p0_master1200.jpg', 0, 3, 0, 4, NULL),
(17, 'Sjdoiajsdoi@gmail.com', '$2y$10$ppFZyBr.ur/Dc6F6up7JcebU40uP5gpiPbrYCZerdAsVIfpj8XWW.', 'SDIFIMI', 'o feg', 'adsfv asdfg', '9994875123', 1, 'C:/xampp/htdocs/practice/assets/3_HuTao_.png', 0, 1, 0, 5, NULL);

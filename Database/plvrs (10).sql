...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2021 at 02:51 PM
...
(1, 'Projectors', '14', 'Sound', 0, NULL),
(2, 'Mobile Speaker', '13', 'Sound', 0, NULL),
(3, 'Monoblock Chairs', '1500', 'Chair', 0, NULL),
(4, 'Projector Screen', '2', 'Screen', 0, NULL),
(5, 'Extension Cords', '10', 'Cord', 0, NULL),
(8, 'asfa', '0', 'asfasf', 0, NULL),
(9, 'zxcb', '0', '1254', 0, NULL),
(10, 'practice', '23', 'zxcv', 0, NULL),
(11, 'srdg`', '25', 'hj', 0, NULL),
(12, 'zxv', '0', 'zxv', 0, NULL),
(13, 'xcvn', '0', 'xcvn', 0, NULL),
(14, 'zdf', '0', 'asf', 0, NULL),
(15, 'Sample', '23', 'lol', 0, NULL);
...
(24, 14, 0, '2021-10-29 10:31:13', 3),
(25, 14, 0, '2021-10-29 10:31:15', 3),
(26, 14, 0, '2021-10-29 10:31:17', 3),
(27, 14, 0, '2021-10-29 10:31:19', 3);
...
(1, 'Making a reservation is a first come, first serve basis whether the requestor is a PLV student, Professor, or Admin Personnel. A reservation will be requested using PLVRS only and it should be requested 3 days before the event.', 1, NULL),
(2, 'To request a reservation, fill out all the required information in reservation form. It will not proceed if there is no attached letter of appoval. When rescheduling, the only requirement is the same letter of approval with rescheduled date that is signed by the respected authorities. A requestor ca', 2, NULL),
(3, 'Requested reservation that are made 2 days before the event, exceeds the maximum capacity of a room, unavailable rooms in PLVRS, and coinciding schedule with other reservations will be declined by the GSO.', 3, NULL),
(4, 'The rooms that can be reserved are: Lecture Room 301, 302, 303, 401, 402, and 403. Pre-school Simulation Room, Business Administration Simulation Room, and Auditorium. The equipment that can be borrowed are: projectors, 2 projector screens, 2 mobile speakers with microphones each, and 1500 monobloc ', 4, NULL),
(5, 'The equipment borrowed must returned directly to the office within the day after using it. If there are damages on a borrowed room or equipment, the requestor will be contacted by the GSO and must personally go to their office.', 5, NULL),
(6, 'Requestor cannot borrow an equipment if there is no room reserved. Auditorium only allow 1 reservation per day. One projector is allowed to borrow per Lecture and Simulation Room. ', 6, NULL),
(35, 'xcvxcvxcvxcvxcv', 7, NULL),
(36, 'vbmg', 5, NULL),
(37, '6ulryufl', 8, NULL),
(38, '', 9, NULL),
(39, '', 1, NULL);
...
INSERT INTO `tbl_reservation` (`r_ID`, `r_event`, `r_startDateAndTime`, `r_endDateAndTime`, `r_status`, `r_user_ID`, `r_approved_ID`, `r_room_ID`, `r_reviewed`, `r_letter_file`, `r_Remarks`, `isDeleted`) VALUES
(481, 'asdasd', '2021-10-21 08:00:00', '2021-10-22 09:00:00', 0, 13, 1, 2, 0, 'C:/xampp/htdocs/practice/assets/039e462305c40d47ea99b2e9b4a330e5.jpg', '', NULL),
(482, 'Something', '2021-10-21 08:00:00', '2021-10-21 09:00:00', 0, 13, 1, 1, 0, 'C:/xampp/htdocs/practice/assets/147340154_148337303789733_1933449064246305894_o.png', '', NULL),
(483, NULL, '2021-10-30 08:00:00', '2021-10-30 09:00:00', 0, 13, 2, 1, 0, 'C:/xampp/htdocs/practice/assets/03.png', '', NULL),
(484, NULL, '2021-11-01 08:00:00', '2021-11-01 09:00:00', 0, 14, 3, 2, 0, 'C:/xampp/htdocs/practice/assets/Page1.png', '', NULL);
...
(1, 'LR 303', 50, '3rd Lecture Room in Floor', 0, NULL),
(2, 'LR 401', 50, '1st Lecture Room in Floor', 0, NULL),
(3, 'LR 402', 50, '2nd Lecture Room in Floor', 0, NULL),
(4, 'Auditorium', 500, 'Auditorium', 0, NULL),
(5, 'BA simulation', 50, 'BA simulation', 0, NULL),
(6, 'Pre school simulation', 120, 'Pre school simulation', 0, NULL),
(7, 'Speech Laboratory', 0, 'Speech Laboratory', 0, NULL),
(8, 'Student Lounge', 0, 'Student Lounge', 0, NULL),
(9, 'Holding Area', 0, 'Holding Area', 0, NULL),
(10, 'adsg', 1245, 'awd', 0, NULL),
(11, 'zcvb', 136, 'asd', 0, NULL),
(12, 'zbz', 0, '124', 0, NULL),
(13, 'zbz', 0, '124', 0, NULL),
(14, 'cvn', 0, 'afzxv', 0, NULL),
(15, 'vbnrh', 0, 'ae123', 0, NULL),
(16, 'vbnrh', 0, 'ae123', 0, NULL);
...
--
ALTER TABLE `tbl_reservation`
  MODIFY `r_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=485;
...
ALTER TABLE `tbl_reservation`
  ...
  ADD CONSTRAINT `tbl_reservation_ibfk_4` FOREIGN KEY (`r_ID`) REFERENCES `tbl_equipment_reserved` (`r_ID`);

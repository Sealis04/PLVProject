...
(3, 'LR 402', 502, '2nd Lecture Room in Floor', 1, 1),
...
(13, 'admin1@gmail.com', '$2y$10$AWJtx8Od.kq/3XCnnPGO0.KYknstQL8COfywaUz7FswJ7N5B/5o1K', 'Admin', 'Darilag', 'Garcia', '9399465176', 1, 1, 1, 1, 1, 4),
(14, 'user1@gmail.com', '$2y$10$ZLiYnQmADleMdiI.UO5EWesok.d4WqwYdH3kqo4sPanAQu.LvHUpG', 'Bryan', 'Darilag', 'Garcia', '9399465176', 1, 1, 0, 1, 0, 11),
(15, 'user2@gmail.com', '$2y$10$ej/E2MuY.7KzwB6LbAhlquQh4Sp6sUWs6dEONhlNjiEflrvRAhqFu', 'Juan', 'Pedro', 'Penduko', '9098898899', 1, 1, 0, 3, 0, 11);
...
--
-- Indexes for table `tbl_letterforregistration`
--
ALTER TABLE `tbl_letterforregistration`
  ADD KEY `u_ID` (`u_ID`);
...
--
ALTER TABLE `tbl_equipment`
  MODIFY `equipment_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `tbl_letterlist`
--
ALTER TABLE `tbl_letterlist`
  MODIFY `letter_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT for table `tbl_notification`
--
ALTER TABLE `tbl_notification`
  MODIFY `notificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;
...
--
ALTER TABLE `tbl_reservation`
  MODIFY `r_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
-- Constraints for table `tbl_letterforregistration`
--
ALTER TABLE `tbl_letterforregistration`
  ADD CONSTRAINT `tbl_letterforregistration_ibfk_1` FOREIGN KEY (`u_ID`) REFERENCES `tbl_user` (`user_ID`);
